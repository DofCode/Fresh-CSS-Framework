/**!
* (c) 2017 atomiks (Tooltip) & FezVrasta (Popper)
* @file tooltip.js (popper.js 1.9.3 included) | Pure JS Tooltip Library
* @version 0.12.1
* @license MIT
*/
...
var SELECTORS = {
    ...
    arrow: '[x-arrow]',
    el: '[data-tooltipped]',
    controller: '[data-tooltip-controller]'
};
...
function handleDocumentTouchstart() {
    ...
    if (/(iPad|iPhone|iPod)/g.test(navigator.userAgent) && !window.MSStream) {
        document.body.classList.add('tooltip-touch');
    }
...
function handleDocumentClick(event) {
    ...
    // Don't trigger a hide for tooltip controllers, and don't needlessly run loop
...
function createPopperElement(id, title, settings) {
    ...
    popper.setAttribute('class', 'tooltip-popper');
    popper.setAttribute('role', 'tooltip');
    popper.setAttribute('aria-hidden', 'true');
    popper.setAttribute('id', 'tooltip-tooltip-' + id);

    var tooltip = document.createElement('div');
    tooltip.setAttribute('class', 'tooltip-tooltip tooltip-tooltip--' + size + ' ' + theme + '-theme leave');
    ...
    content.setAttribute('class', 'tooltip-tooltip-content');
    ...
    if (html) {
        ...
        if (html instanceof Element) {
            ...
            templateId = html.id || 'tooltip-html-template';
        } else {
...
function hideAllPoppers(currentRef) {
    STORE.refs.forEach(function (ref) {
        var popper = ref.popper,
            tooltipInstance = ref.tooltipInstance,
        ...
        if (isHideOnClick && isNotCurrentRef) {
            tooltipInstance.hide(popper, hideDuration);
        }
    });
}
    ...
    createClass$1(Tooltip, [{
        ...
        */
        ...
        value: function _createTooltips(els) {
            ...
            els.forEach(function (el) {
                ...
                el.setAttribute('aria-describedby', 'tooltip-tooltip-' + id);
                ...
                pushIntoStorage({
                    ...
                    settings: settings,
                    listeners: listeners,
                    tooltipInstance: _this4
                });

                GLOBALS.idCounter++;
            });

            Tooltip.store = STORE; // Allow others to access `STORE` if need be
        }
        ...
        */
        ...
        value: function getPopperElement(el) {
            try {
                ...
                throw new Error('[Tooltip error]: Element does not exist in any Tooltip instances');
            }
        }
        ...
        */
        ...
        value: function getTooltippedElement(popper) {
            try {
                ...
                throw new Error('[Tooltip error]: Popper does not exist in any Tooltip instances');
            }
        }
        ...
        */
        ...
        value: function show(popper) {
            ...
            onTransitionEnd(ref, duration, function () {
                ...
                !ref.settings.transitionFlip && tooltip.classList.add('tooltip-notransition');
        ...
        */
        ...
        value: function hide(popper) {
            ...
            if (enableCallback) {
                ...
                ref.hidden = true;
                !ref.settings.transitionFlip && tooltip.classList.remove('tooltip-notransition');
            }
        ...
        */
        ...
        value: function destroy(popper) {
            ...
            // Remove Tooltip-only event listeners from tooltipped element
